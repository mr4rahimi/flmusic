# apps/web — نسخه‌ی وب فول موزیک

نسخه‌ی وب سرور-رندر پلتفرم، با تمرکز بر SEO فارسی.
...
| [۰۵ — اتصال به API](docs/05-api-integration.md) | endpointها، شکل پاسخ‌ها، مشکلات API |
